...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public static final byte PERMISSION_MANAGE_EXTERNAL_STORAGE_REQUEST_CODE = 5;
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == PERMISSION_MANAGE_EXTERNAL_STORAGE_REQUEST_CODE) {
    ...
    private boolean requestAppPermissions() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            if (!Environment.isExternalStorageManager()) {
                ...
                startActivityForResult(intent, PERMISSION_MANAGE_EXTERNAL_STORAGE_REQUEST_CODE);
                return true;
            }
            return false;
        }
