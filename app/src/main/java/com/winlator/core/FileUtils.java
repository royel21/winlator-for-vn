...
public abstract class FileUtils {
        ...
        if ("com.android.externalstorage.documents".equals(authority) ||
            ...
            if (docId.contains(":")) {
                ...
                if ("primary".equalsIgnoreCase(type)) {
                    path = Environment.getExternalStorageDirectory() + (relativePath.isEmpty() ? "" : "/" + relativePath);
                } else {
                    path = "/storage/" + type + (relativePath.isEmpty() ? "" : "/" + relativePath);
                    if (!(new File(path)).exists()) {
                        path = "/mnt/media_rw/" + type + (relativePath.isEmpty() ? "" : "/" + relativePath);
                    }
                }
    ...
    public static ArrayList<String> getExternalStoragePaths(Context context) {
