...
public class NotificationUtils {
    ...
    public NotificationUtils(Context context) {
        ...
        this.notificationManager = (NotificationManager) (this.context == null ? null
                : this.context.getSystemService(Context.NOTIFICATION_SERVICE));
        createNotificationChannel();
    }

    /**
     * Sends or updates a notification with default title, services class, and exit
     * action.
     */
    ...
    public void notify(int id, String content, String title, Class<?> serviceClass, String exitAction) {
        Notification notification = createForegroundNotification(content, title, serviceClass, exitAction,
                MainActivity.class);
     ...
     */
    public Notification createForegroundNotification(String content, String title, Class<?> serviceClass,
            String exitAction, Class<?> targetActivity) {
    ...
    /**
     * Overload of createForegroundNotification() with default title and target
     * activity.
     */
     ...
     * @param importance Importance level (e.g.,
     ...
     *
     * @param context            The context of the app for getting the package
     *                           name.
     * @param notificationIDName A string that identifies the notification and is
     *                           used
